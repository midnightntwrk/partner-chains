	...
	mod candidate_registration_entry_serialization_tests {
		...
		fn candidate_registration_entry_to_json() {
			let response = CandidateRegistrationEntry {
				...
				keys: vec![("safr".to_string(), ByteString::from_hex_unsafe("0x90b5ab205c6974c9ea841be688864633dc9ca8a357843eeacf2314649965fe22")), ("gran".to_string(),ByteString::from_hex_unsafe("439660b36c6c03afafca027b910b4fecf99801834c62a5e6006f27d978de234f"))].into_iter().collect(),
			...
			assert_eq!(
				...
				serde_json::json!({
					...
					"keys": {"safr":"0x90b5ab205c6974c9ea841be688864633dc9ca8a357843eeacf2314649965fe22", "gran": "0x439660b36c6c03afafca027b910b4fecf99801834c62a5e6006f27d978de234f"},
