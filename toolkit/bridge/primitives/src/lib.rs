...
//! 4. Complete the configuratio of the pallet by setting the correct main chain script information
//!    via an extrinsic. This step requires the governance authority to know the main chain script
//!    values, which it should obtain using the offchain.
//!
